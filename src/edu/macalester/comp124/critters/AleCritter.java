...
public class AleCritter extends Critter {
    private static final Color
            strokeColor = new Color(182, 168, 35),
            fillColor   = new Color(182, 102, 177);
    @Override
    protected void buildGraphics() {
        ...
        Ellipse body = new Ellipse(-20,-30,40,40);
        body.setStrokeColor(strokeColor);
        body.setFilled(true);
        body.setFillColor(fillColor);
        getGraphics().add(body);

        Ellipse Head = new Ellipse(-18,-56,36,20);
