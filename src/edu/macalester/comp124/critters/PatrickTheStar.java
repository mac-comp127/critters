...
public class PatrickTheStar extends Critter {
    ...
    protected void buildGraphics() {
        ...
        Rectangle rightLeg  = new Rectangle(110, 245, 20, 50);
        ...
        Image patrick = null;
        try{
            patrick = new Image(0,0, Paths.get(getClass().getResource("/Patrick_Star.png").toURI()).toString());
        } catch (URISyntaxException e){
            e.printStackTrace();
        }
        getGraphics().add(patrick);

        addEye(new Eye(15, 0.5, 0.18, Color.WHITE), 95, 60);
        addEye(new Eye(15, 0.5, 0.18, Color.WHITE), 125, 60);
    }
}
